...
function downloadCSV(args) {  
    ...
    const handleSubmit = async (e) =>{      //calling on submit
		...
		else if(subcategory.subcategoryname === "" || subcategory.subcategoryname === null || subcategory.subcategoryname === undefined)
		{
    ...
    const handleSubmitEdit = async (e) =>{      //calling on submit
		...
		else if(edituserdata.subcategoryname === "" || edituserdata.subcategoryname === null || edituserdata.subcategoryname === undefined)
		{
			toast.error("Please enter subcategory !" );
			return;
		}
...
async function ShowpopupEdit(getid)
{
	...
	if(singlecategorydata)
		...
		{
			Setedituserdata({categoryid:"",subcategoryname:"", status:""});
		}
