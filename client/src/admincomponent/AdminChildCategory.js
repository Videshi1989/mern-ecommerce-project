...
async function ShowpopupEdit(getid)
{
  ...
  document.getElementById('popupedit').style='display:block';
	...
	{
		Setedituserdata({categoryid:"",subcategoryid:"",childcategoryname:"", status:""});
...
function downloadCSV(args) {  
    ...
    const handleSubmit = async (e) =>{      //calling on submit
		...
		else if(childcategory.childcategoryname === "" || childcategory.childcategoryname === null || childcategory.childcategoryname === undefined)
		{
			toast.error("Please enter child-category !");
			return;
		}
    ...
    const handleSubmitEdit = async (e) =>{      //calling on submit
		...
		else if(edituserdata.childcategoryname === "" || edituserdata.childcategoryname === null || edituserdata.childcategoryname === undefined)
		{
			toast.error("Please enter child-category !");
			return;
		}
